...
EXPRESSION_ASSESSMENT_REQUIREMENT_PROMPT = ("1. 上述是是用户的一段口语表达."
                                            ...
                                            "7. 你的回答需要以第二人称,并对用户称呼'您'.你的语气可以带有一些鼓励的口吻.另外,不要给出任何要求之外的答复(比如,你不需要介绍你自己,你不需要说你将全力以赴完成任务,你不需要说希望你给的建议对用户有帮助,你不需要说'如果你遇到了任何其他问题或需要进一步的帮助，请随时告诉我')."
)
