...
def transcribe_audio(audio_file_path):
    print("transcribe_audio method is called, audio_file_path: " + audio_file_path)
    model_size = "large-v2"
    ...
    print("transcribe_audio method is called")
    print(transcription)
...
def asynchronously_update_context(topic_id, message, latest_conversation): #TODO 更新context(暂未实现异步更新)
    ...
    if conversations.count() % UPDATE_CONTEXT_THRESHOLD == 0 :
        ...
        message.append({"role": "user", "content": "Please summarize the context and content of your previous conversation with the user. The summary text should contain the main information of the user, the main context and details of the conversation. The summarized text should be limited to 250 words"})
